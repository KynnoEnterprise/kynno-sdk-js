...
export namespace kynno.rewardshare.v1 {
    export class GenesisState extends pb_1.Message {
        ...
        get rewardshares() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.kynno.rewardshare.v1.Rewardshare, 2) as dependency_1.kynno.rewardshare.v1.Rewardshare[];
        }
        ...
        static fromObject(data: {
            ...
            if (data.rewardshares != null) {
                message.rewardshares = data.rewardshares.map(item => dependency_1.kynno.rewardshare.v1.Rewardshare.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.rewardshares != null) {
                data.rewardshares = this.rewardshares.map((item: dependency_1.kynno.rewardshare.v1.Rewardshare) => item.toObject());
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.rewardshares !== undefined)
                writer.writeRepeatedMessage(2, this.rewardshares, (item: dependency_1.kynno.rewardshare.v1.Rewardshare) => item.serialize(writer));
            if (!w)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.rewardshares, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_1.kynno.rewardshare.v1.Rewardshare.deserialize(reader), dependency_1.kynno.rewardshare.v1.Rewardshare));
                        break;
    ...
    export class Params extends pb_1.Message {
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                if ("enable_reward_share" in data && data.enable_reward_share != undefined) {
                    this.enable_reward_share = data.enable_reward_share;
                }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.enable_reward_share !== undefined)
                writer.writeBool(1, this.enable_reward_share);
