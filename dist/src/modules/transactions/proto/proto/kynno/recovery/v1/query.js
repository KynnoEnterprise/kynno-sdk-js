    ...
    (function (_v) {
      ...
      var QueryParamsResponse = /*#__PURE__*/function (_pb_1$Message2) {
        ...
        (0, _createClass2["default"])(QueryParamsResponse, [{
          key: "params",
          get: function get() {
            return pb_1.Message.getWrapperField(this, dependency_3.kynno.recovery.v1.Params, 1);
          },
          ...
          value: function fromObject(data) {
            ...
            if (data.params != null) {
              message.params = dependency_3.kynno.recovery.v1.Params.fromObject(data.params);
            }
              ...
              switch (reader.getFieldNumber()) {
                case 1:
                  reader.readMessage(message.params, function () {
                    return message.params = dependency_3.kynno.recovery.v1.Params.deserialize(reader);
                  });
                  break;
